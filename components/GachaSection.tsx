...
import { Sparkles, Dices, HelpCircle, Dna, Lock, Sprout } from 'lucide-react';
  ...
  return (
    <div className="h-full flex flex-col relative p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-4 custom-scrollbar content-start">
         ...
         <SpendCard type={TableType.SKILLS} label="Skills" subLabel="+10 Level Cap" description={`1 of ${SKILLS_LIST.length} Skills`} disabled={!canUnlock.skills} keysAvailable={keys > 0} complete={!canUnlock.skills} priceDisplay="1-2" iconSrc={OSRS_GACHA_ICONS.SKILLS} onClick={() => handleUnlock(TableType.SKILLS)} />
